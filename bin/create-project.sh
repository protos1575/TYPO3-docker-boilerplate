...
case "$1" in
    ...
    ###################################
    "typo3")
        execInDir "$CODE_DIR" "docker run --rm --env COMPOSER_CACHE_DIR=/tmp --user $(id -u):$(id -g) -e COMPOSER_PROCESS_TIMEOUT=30 -v \$(pwd):/app composer create-project typo3/cms:dev-master /app"
